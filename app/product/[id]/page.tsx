    ...
    return (
        <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <button
                    className="flex items-center text-green-500 hover:text-green-400 mb-8 transition duration-300"
                    onClick={() => router.push('/')}
                >
                    ...
                    <div className="md:flex">
                        ...
                        <div className="p-8">
                            ...
                            <div className="mt-6 flex items-center space-x-4">
                                <button
                                    className={`flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-black bg-green-500 hover:bg-green-400 md:py-4 md:text-lg md:px-10 transition duration-300 ${addedToCart ? 'scale-105' : ''}`}
                                ...
                                <button
                                    className={`flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md ${inWishlist ? 'text-red-500 bg-gray-800 hover:bg-gray-700' : 'text-gray-300 bg-gray-800 hover:bg-gray-700'} md:py-4 md:text-lg md:px-10 transition duration-300`}
